...
```{r warning=FALSE}
gm %>% 
  filter(time == 2016, !is.na(name), !is.na(lifeExpectancy)) %>% 
  ggplot() +
    geom_point(aes(x = lifeExpectancy, y = GDP_PC,
               size = totalPopulation/1000000, col = region),
               alpha = 0.5) + 
...
It looks like most portions of the various continents are very poor in terms of GDP Per Capita, and less portions of the various continents are rich as GDP Per Capita increases. Overall the GDP Per Capita has increases tremendously.
