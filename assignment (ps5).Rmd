...
There are some missing values in *names* as well as *iso2* compared to no missing values in *iso3*. *iso2* have more missing values then *name*. It is also possible that the one country code could represent more than one country.
...
There are 217 missing co2 emissions each year and the year that has the most missing data is 2019.
